...
- **Comisiones entre negocios**: al vender un equipo cargado por otro negocio, el dueño cobra el **capital** (costo del equipo, automático) + una **comisión manual** que se tipea en el carrito por cada producto ajeno. Los regalos ajenos devuelven capital pero no llevan comisión. Todo se acumula en la **cuenta corriente** de Ganancias (saldo por negocio + detalle de operaciones); informativa, sin estados de pago. Nota: las comisiones son a nivel negocio — con varios usuarios por negocio, la "ganancia neta" mezcla comisiones del negocio con ventas propias (limitación aceptada mientras haya un usuario por negocio).
